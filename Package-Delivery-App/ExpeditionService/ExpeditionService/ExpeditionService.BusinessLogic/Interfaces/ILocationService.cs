...
namespace ExpeditionService.BusinessLogic.Interfaces
{
    ...
    public interface ILocationService: IBaseService<LocationDto>
    {
        ...
        /// </summary>
        /// <param name="country">the country of the location that we want to get
        /// <returns>A <see cref="Task"/> that contains <seealso cref="LocationDto"/></returns>
        ...
        /// </summary>
        /// <param name="postalcode">the postalcode of the entity that will help us to access the postal code in the record 
        /// <returns>A <see cref="Task"/> that contains <seealso cref="LocationDto"/></returns>
