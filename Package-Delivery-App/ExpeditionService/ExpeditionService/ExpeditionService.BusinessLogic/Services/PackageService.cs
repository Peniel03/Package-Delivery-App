...
namespace ExpeditionService.BusinessLogic.Services
{
    ...
    public class PackageService: IPackageService
    {
        ...
        /// <exception cref="ArgumentException">the argument exception</exception>
        /// <returns>A <see cref="Task"/>that contains <seealso cref="PackageDto"/></returns>
        public async Task<PackageDto> DeleteAsync(string id, CancellationToken cancellationToken)
        {
        ...
        /// <returns>A <see cref="Task"/>that contains A list of<seealso cref="PackageDto"/></returns>
